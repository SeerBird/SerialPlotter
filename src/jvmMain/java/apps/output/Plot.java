...
public class Plot extends Canvas {
        ...
        if (dataSet == null) {
            ...
            if (dataSet == null) {
                ...
                SwingUtilities.invokeLater(() -> {
                    ...
                    totheight = Math.min(26 * DevConfig.legendEntryNum + 8, totheight + 8);
    ...
    public void paint(@NotNull Graphics g) {
        ...
        try {
            ...
            int pwidth = width;
            int pheight = height - 2 * DevConfig.fontSize;
    ...
    private int plotYFromValue(float min, float max, float value) {
        int y = Math.round(getHeight() - DevConfig.fontSize - (getHeight() - 2 * DevConfig.fontSize) * (value - min) / (max - min));
        return y;
    }
}
